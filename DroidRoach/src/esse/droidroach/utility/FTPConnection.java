 ...
 * 
 * Modified by Stefano Gabryel(24 October 2013)
 * Added getServerBanner() : when the server sends the first "response" i put it in a variable and get it using this getter
 * setTimeOut() : you can now set the connection timeout of the socket, before you had to wait for the socket's default timeout
 * 
 */
...
public class FTPConnection extends Object {
    ...
    private int connectionTimeOut=800;
        ...
        throws UnknownHostException, IOException
    {
        ...
        connectionSocket.connect(new InetSocketAddress(host, port), connectionTimeOut);
    ...
    /**
     * Return the server banner obtained while trying to establish a connection.
     * This function will return null if called before <code>connect(host)</code.
     * Added by Stefano Gabryel
     */
     ...
     * continuation).
     * Modified by Stefano Gabryel
     */
    private int getServerReply()
        throws IOException
    {
    	String reply=getFullServerReply();
